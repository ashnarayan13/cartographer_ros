...
TRAJECTORY_BUILDER_3D.min_range = 3 --Minimum range to use from LiDAR
...
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.linear_z_search_window = 20. --default is 1
POSE_GRAPH.constraint_builder.fast_correlative_scan_matcher_3d.linear_xy_search_window = 30. --default is 1
...
TRAJECTORY_BUILDER_3D.high_resolution_adaptive_voxel_filter.max_range = 50. --Range to which the high res filter should work
...
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.only_optimize_yaw = false --Default is false
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.occupied_space_weight_0 = 1. --High resolution filter weight
TRAJECTORY_BUILDER_3D.ceres_scan_matcher.occupied_space_weight_1 = 7. --Low resolution filter weight
